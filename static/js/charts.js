    ...
    var gaugeData =  [{
        ...
        mode: "gauge+number",
         gauge: {
            ...
            axis: { range: [null, 9] },
            steps: [
                { range: [0, 2], color: 'rgb(224, 204, 255)' },
                { range: [2, 4], color: 'rgb(194, 153, 255)' },
                { range: [4, 6], color: 'rgb(148, 77, 255)' },
                { range: [6, 8], color: 'rgb(102, 0, 255)'},
                { range: [8, 10], color: 'rgb(61, 0, 153)'}
            ],
